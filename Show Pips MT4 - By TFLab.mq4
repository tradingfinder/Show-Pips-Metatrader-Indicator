...
//---
   ...
   if(TextPosition == UpperLeft)
     ...
     {x=int(ChartGetInteger(0,CHART_WIDTH_IN_PIXELS,0))-250; y=10;}

   ObjectsDeleteAll(0,"Show Pips");
   LabelCreate("Show Pips "+Symbol(),x,y,CORNER_LEFT_UPPER,"Current candle pip(s): " +IntegerToString(int((high[0]-low[0])/Point())),"Arial",14,Clr);
